...
from pinar.entity.exposures.litpop import litpop as lp
from pinar.entity.exposures.litpop import gpw_population
from pinar.util.finance import world_bank_wealth_account, gdp, income_group
...
class TestLitPopExposure(unittest.TestCase):
    ...
    def test_switzerland300_pass(self):
        ...
        with self.assertLogs('pinar.entity.exposures.litpop', level='INFO') as cm:
