...
from pinar.engine import ImpactCalc, ImpactFreqCurve, CostBenefit
from pinar.entity import (Entity, ImpactFuncSet, Exposures, DiscRates, ImpfTropCyclone, Measure,
                            MeasureSet)
from pinar.hazard import Hazard, Centroids
from pinar.util.constants import HAZ_DEMO_MAT, ENT_DEMO_TODAY
    ...
    def test_cost_benefit(self):
        ...
        haz_present = client.get_hazard('tropical_cyclone',
                                properties={'country_name': 'Haiti',
                                            'pinar_scenario': 'historical',
                                            'nb_synth_tracks':'10'})
        haz_future = client.get_hazard('tropical_cyclone',
                                properties={'country_name': 'Haiti',
                                            'pinar_scenario': 'rcp60',
