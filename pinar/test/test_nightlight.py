...
from pinar.util.constants import (SYSTEM_DIR, CONFIG)
from pinar.util import files_handler
...
class TestNightlight(unittest.TestCase):
    ...
    def test_read_bm_files(self):
        ...
        with self.assertLogs('pinar.entity.exposures.litpop.nightlight', level='DEBUG') as cm:
    ...
    def test_unzip_tif_to_py(self):
        ...
        # test LOGGER
        with self.assertLogs('pinar.entity.exposures.litpop.nightlight', level='INFO') as cm:
