...
from pinar.util.constants import EARTH_RADIUS_KM, SYSTEM_DIR, DEF_CRS
from pinar.util.files_handler import get_file_names, download_ftp
import pinar.util.plot as u_plot
from pinar.hazard import Centroids
import pinar.hazard.tc_tracks_synth
...
IBTRACS_URL = ('https://www.ncei.noaa.gov/data/'
               'international-best-track-archive-for-pinar-stewardship-ibtracs/'
...
class TCTracks():
    ...
    def from_ibtracs_netcdf(cls, provider=None, rescale_windspeeds=True, storm_id=None,
        ...
        PINAR documentation can't replace a thorough understanding of the underlying data. This
        ...
        file_name : str, optional
            Name of NetCDF file to be dowloaded or located at pinar/data/system.
    ...
    def calc_perturbed_trajectories(self, **kwargs):
        """See function in `pinar.hazard.tc_tracks_synth`."""
        pinar.hazard.tc_tracks_synth.calc_perturbed_trajectories(self, **kwargs)
    ...
    def from_netcdf(cls, folder_name):
        ...
        ``~/pinar/data/system`` folder and use the ``TCTracks.from_ibtracks_netcdf``
        classmethod.
