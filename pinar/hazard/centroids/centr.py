...
class Centroids():
    ...
    def from_base_grid(land=False, res_as=360, base_file=None):
        """Initialize from base grid data provided with PINAR
        ...
        base_file : str, optional
            If set, read this file instead of one provided with pinar.
        """
    ...
    def from_mat(cls, file_name, var_names=None):
        """Read centroids from PINAR's MATLAB version.
    ...
    def union(self, *others):
        ...
        Parameters
        ----------
        others : any number of pinar.hazard.Centroids()
...
def generate_nat_earth_centroids(res_as=360, path=None, dist_coast=False):
    ...
    `NATEARTH_CENTROIDS`. These files are provided with PINAR so that this function should never
    be called!
