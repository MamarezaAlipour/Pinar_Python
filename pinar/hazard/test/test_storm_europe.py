...
from pinar.hazard.storm_europe import StormEurope, generate_WS_forecast_hazard
from pinar.hazard.centroids.centr import DEF_VAR_EXCEL, Centroids
...
class TestReader(unittest.TestCase):
    ...
    def test_icon_read(self):
        ...
        # instead, we download it as a test dataset through the pinar data api
        apiclient = Client()
        ...
        with self.assertLogs('pinar.hazard.storm_europe', level='WARNING') as cm:
