...
from pinar.hazard.tc_tracks import TCTracks
from pinar.hazard.trop_cyclone import (
...
class TestPinarSce(unittest.TestCase):
    def test_apply_criterion_track(self):
        ...
        tc_cc = tc.apply_pinar_scenario_knu(ref_year=2050, rcp_scenario=45)
        ...
        self.assertEqual(
            ...
            'pinar change scenario for year 2050 and RCP 45 from Knutson et al 2015.')
...
if __name__ == "__main__":
    ...
    TESTS.addTests(unittest.TestLoader().loadTestsFromTestCase(TestPinarSce))
