...
from pinar.util.constants import DEF_FREQ_UNIT, HAZ_TEMPLATE_XLS, HAZ_DEMO_FL
...
class TestAppend(unittest.TestCase):
    ...
    def test_append_raise_type_error(self):
        ...
        from pinar.hazard import TropCyclone
        haz2 = TropCyclone()
...
class TestHDF5(unittest.TestCase):
    ...
    def test_write_read_unsupported_type(self):
        ...
        with self.assertLogs(logger="pinar.hazard.base", level="WARN") as cm:
            hazard.write_hdf5(file_name)
...
def dummy_step_impf(haz):
    from pinar.entity import ImpactFunc
