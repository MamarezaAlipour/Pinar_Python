...
from pinar.util.files_handler import get_file_names
from pinar.util.dates_times import (datetime64_to_ordinal,
                                      last_year,
                                      first_year,
                                      date_to_str
                                      )
from pinar.util.dwd_icon_loader import (download_icon_centroids_file,
                                          download_icon_grib,
                                          delete_icon_grib,
                                          )
...
class StormEurope(Hazard):
    ...
    events can be downloaded at http://wisc.pinar.copernicus.eu/ and read
    ...
    def calc_ssi(self, method='dawkins', intensity=None, on_land=True,
        ...
        https://wisc.pinar.copernicus.eu/wisc/#/help/products#tier1_section
