...
from pinar.util.constants import ONE_LAT_KM, DEF_CRS, CMAP_RASTER
...
class Exposures():
    ...
    def __init__(self, *args, meta=None, tag=None, ref_year=DEF_REF_YEAR,
        ...
        tag : pinar.entity.exposures.tag.Tag, optional
    ...
    def _access_item(self, *args):
        raise TypeError("Since PINAR 2.0, Exposures objects are not subscriptable. Data "
    ...
    def assign_centroids(self, hazard, distance='euclidean',
        ...
        See Also
        --------
        pinar.util.coordinates.assign_coordinates
    ...
    def from_hdf5(cls, file_name):
        ...
        with pd.HDFStore(file_name, mode='r') as store:
            ...
            # in previous versions of PINAR and/or geopandas, the CRS was stored in '_crs'/'crs'
