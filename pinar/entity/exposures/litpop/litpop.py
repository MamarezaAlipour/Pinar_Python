...
import pinar.util.finance as u_fin

from pinar.entity.tag import Tag
from pinar.entity.exposures.litpop import nightlight as nl_util
from pinar.entity.exposures.litpop import gpw_population as pop_util
from pinar.entity.exposures.base import Exposures, INDICATOR_IMPF, DEF_REF_YEAR
...
def _grp_read(country_iso3, admin1_info=None, data_dir=SYSTEM_DIR):
    ...
    "GSDP" in pinars data folder (or in the specified folder). The excel file should bear the
...
def _calc_admin1_one_country(country, res_arcsec, exponents, fin_mode, total_value,
    ...
    excel files in a subfolder "GSDP" in pinars data folder. The excel files should contain a row
