...
from pinar.entity.impact_funcs.impact_func_set import ImpactFuncSet, ImpactFunc, Tag
...
class TestContainer(unittest.TestCase):
    ...
    def test_add_wrong_error(self):
        ...
        imp_fun = ImpactFuncSet()
        vulner_1 = ImpactFunc()
        with self.assertLogs('pinar.entity.impact_funcs.impact_func_set',
                             level='WARNING') as cm:
    ...
    def test_remove_wrong_error(self):
        ...
        imp_fun = ImpactFuncSet([ImpactFunc("TC", 1)])
        with self.assertLogs('pinar.entity.impact_funcs.impact_func_set', level='WARNING') as cm:
