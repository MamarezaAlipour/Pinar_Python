...
from pinar.entity.impact_funcs.impact_func_set import ImpactFuncSet
from pinar.entity.disc_rates.base import DiscRates
from pinar.entity.measures.measure_set import MeasureSet
from pinar.entity.exposures.base import Exposures
...
class Entity:
    ...
    def from_excel(cls, file_name, description=''):
        """Read csv or xls or xlsx file following pinar's template.
