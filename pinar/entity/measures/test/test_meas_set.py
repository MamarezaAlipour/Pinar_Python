...
from pinar.entity.measures.base import Measure
from pinar.entity.measures.measure_set import MeasureSet
from pinar.util.constants import ENT_TEMPLATE_XLS, ENT_DEMO_TODAY
...
class TestContainer(unittest.TestCase):
    ...
    def test_add_wrong_error(self):
        ...
        meas = MeasureSet()
        with self.assertLogs('pinar.entity.measures.measure_set', level='WARNING') as cm:
            meas.append(Measure())
    ...
    def test_remove_wrong_error(self):
        ...
        meas = MeasureSet(measure_list=[Measure(name='Mangrove', haz_type='FL')])
        with self.assertLogs('pinar.entity.measures.measure_set', level='INFO') as cm:
