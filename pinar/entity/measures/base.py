...
from pinar.entity.exposures.base import Exposures, INDICATOR_IMPF, INDICATOR_CENTR
...
class Measure():
    ...
    exposures_set : str  or pinar.entity.Exposure
    ...
    def __init__(
        ...
        hazard_freq_cutoff : float, optional
            hazard frequency cutoff
        exposures_set : str  or pinar.entity.Exposure, optional
            file name of exposure to use (in h5 format) or Exposure instance
    ...
    def calc_impact(self, exposures, imp_fun_set, hazard, assign_centroids=True):
        ...
        exposures : pinar.entity.Exposures
            exposures instance
        imp_fun_set : pinar.entity.ImpactFuncSet
            impact function set instance
        hazard : pinar.hazard.Hazard
            hazard instance
    ...
    def _calc_impact(self, new_exp, new_impfs, new_haz, assign_centroids):
        ...
        Parameters
        ----------
        new_exp : pinar.entity.Exposures
        ...
        pinar.engine.Impact
        """
        from pinar.engine.impact_calc import ImpactCalc  # pylint: disable=import-outside-toplevel
    ...
    def _change_imp_func(self, imp_set):
        ...
        Parameters
        ----------
        imp_set : pinar.entity.ImpactFuncSet
            impact function set instance to be modified

        Returns
        -------
        new_imp_set : pinar.entity.ImpactFuncSet
    ...
    def _filter_exposures(self, exposures, imp_set, hazard, new_exp, new_impfs,
        ...
        Returns
        -------
        new_exp,new_ifs, new_haz : pinar.entity.Exposures,
                                   pinar.entity.ImpactFuncSet,
                                   pinar.hazard.Hazard
