...
class DiscRates():
    ...
    def select(self, year_range):
        ...
        Returns: pinar.entity.DiscRates
    ...
    def append(self, disc_rates):
        ...
        Parameters
        ----------
        disc_rates: pinar.entity.DiscRates
    ...
    def from_mat(cls, file_name, description='', var_names=None):
        """
        Read MATLAB file generated with previous MATLAB PINAR version.
