...
from pinar.entity.disc_rates import DiscRates
from pinar.hazard.base import Hazard
from pinar.engine.cost_benefit import CostBenefit, risk_aai_agg, \
        risk_rp_100, risk_rp_250, _norm_values
from pinar.engine import ImpactCalc
from pinar.util.constants import ENT_DEMO_FUTURE, ENT_DEMO_TODAY
from pinar.util.api_client import Client

from pinar.test import get_test_file
...
class TestSteps(unittest.TestCase):
    ...
    def test_calc_impact_measures_pass(self):
        ...
        self.assertEqual(cost_ben.tot_pinar_risk, 0.0)
    ...
    def test_calc_cb_no_change_pass(self):
        ...
        self.assertAlmostEqual(cost_ben.tot_pinar_risk, 1.2150496306913972e+11, places=3)
    ...
    def test_calc_cb_change_pass(self):
        ...
        self.assertEqual(cost_ben.present_year, 2018)
        self.assertEqual(cost_ben.future_year, 2040)
        self.assertAlmostEqual(cost_ben.tot_pinar_risk, 5.768659152882021e+11, places=3)
        ...
        self.assertAlmostEqual(cost_ben.tot_pinar_risk, 576865915288.2021, places=3)
