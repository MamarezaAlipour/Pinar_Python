...
from pinar.util.constants import DEMO_DIR

import pinar.engine.impact_data as im_d
...
class TestEmdatToImpact(unittest.TestCase):
    """Test import of EM-DAT data (as CSV) to Impact-instance (PINAR)"""
    def test_emdat_to_impact_all_countries_pass(self):
        """test import EM-DAT to Impact() for all countries in CSV"""
        # =====================================================================
        # emdat_to_impact(emdat_file_csv, hazard_type_pinar, \
