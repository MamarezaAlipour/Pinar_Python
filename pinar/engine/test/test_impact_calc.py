...
from pinar.engine import ImpactCalc, Impact
from pinar.engine.impact_calc import LOGGER as ILOG
from pinar.util.constants import ENT_DEMO_TODAY, DEMO_DIR
...
class TestImpactCalc(unittest.TestCase):
    ...
    def test_calc_insured_impact_no_insurance(self):
        ...
        self.assertEqual(logs.output, [
            "INFO:pinar.engine.impact_calc:Calculating impact for 150 assets (>0) and 14450 events."
        ])
        self.assertEqual(icalc.n_events, len(impact.at_event))
        self.assertEqual(0, impact.at_event[0])
        self.assertEqual(0, impact.at_event[7225])
