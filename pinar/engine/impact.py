...
from pinar.entity import Exposures, Tag
from pinar.hazard import Tag as TagHaz
import pinar.util.plot as u_plot
from pinar import CONFIG
from pinar.util.constants import DEF_CRS, CMAP_IMPACT, DEF_FREQ_UNIT
...
#TODO: new name
    ...
    def from_eih(cls, exposures, impfset, hazard,
        ...
        impfset: pinar.entity.ImpactFuncSet
...
#TODO: rewrite and deprecate method
    ...
    def from_csv(cls, file_name):
        ...
        Returns
        -------
        imp : pinar.engine.impact.Impact
    ...
    def from_hdf5(cls, file_path: Union[str, Path]):
        ...
        As per the :py:func:`pinar.engine.impact.Impact.__init__`, any of these entries
    ...
    def video_direct_impact(exp, impf_set, haz_list, file_name='',
        ...
        Parameters
        ----------
        exp : pinar.entity.Exposures
            exposures instance, constant during all video
        impf_set : pinar.entity.ImpactFuncSet
            impact functions
...
#TODO: rewrite and deprecate method
    ...
    def concat(cls, imp_list: Iterable, reset_event_ids: bool = False):
        ...
        Parameters
        ----------
        imp_list : Iterable of pinar.engine.impact.Impact
        ...
        Returns
        --------
        impact: pinar.engine.impact.Impact
