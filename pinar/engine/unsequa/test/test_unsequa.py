...
from pinar.entity import ImpactFunc, ImpactFuncSet
from pinar.entity.entity_def import Entity
from pinar.entity import Exposures
from pinar.hazard import Hazard
from pinar.engine.unsequa import InputVar, CalcImpact, UncOutput, CalcCostBenefit

from pinar.util.constants import EXP_DEMO_H5, HAZ_DEMO_H5, ENT_DEMO_TODAY, ENT_DEMO_FUTURE
from pinar.util.constants import  TEST_UNC_OUTPUT_IMPACT, TEST_UNC_OUTPUT_COSTBEN
...
class TestCalcCostBenefit(unittest.TestCase):
    ...
    def test_init_pass(self):
        ...
        self.assertTupleEqual(
            unc_calc._metric_names,
            ('tot_pinar_risk', 'benefit', 'cost_ben_ratio',
    ...
    def test_calc_uncertainty_pass(self):
        ...
        self.assertEqual(
            unc_data.tot_pinar_risk_unc_df.size,
            unc_data.n_samples
            )
        self.assertEqual(
