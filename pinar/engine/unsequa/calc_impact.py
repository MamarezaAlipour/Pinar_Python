...
from pinar.engine.unsequa import Calc, InputVar, UncImpactOutput
from pinar.entity import Exposures, ImpactFuncSet
...
class CalcImpact(Calc):
    ...
    pinar.engine.impact.Impact() object.
    ...
    exp_input_var : pinar.engine.uncertainty.input_var.InputVar
        Exposure uncertainty variable
    impf_input_var : pinar.engine.uncertainty.input_var.InputVar
    ...
    def __init__(
        ...
        Parameters
        ----------
        exp_input_var : pinar.engine.uncertainty.input_var.InputVar or pinar.entity.Exposure
            Exposure uncertainty variable or Exposure
        impf_input_var : pinar.engine.uncertainty.input_var.InputVar or pinar.entity.ImpactFuncSet
            Impact function set uncertainty variable or Impact function set
        haz_input_var : pinar.engine.uncertainty.input_var.InputVar or pinar.hazard.Hazard
    ...
    def uncertainty(self,
        ...
        Parameters
        ----------
        unc_sample : pinar.engine.uncertainty.unc_output.UncOutput
        ...
        Returns
        -------
        unc_output : pinar.engine.uncertainty.unc_output.UncImpactOutput
        ...
        See Also
        --------
        pinar.engine.impact: Compute risk.
