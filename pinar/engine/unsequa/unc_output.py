...
from pinar.util.value_representation import value_to_monetary_unit as u_vtm
from pinar.util.value_representation import convert_monetary_value as u_cmv
from pinar.util import plot as u_plot
...
class UncOutput():
    ...
    analysis  done on pinar.engine.impact.Impact() or
    pinar.engine.costbenefit.CostBenefit() object.
    ...
    def plot_sensitivity_map(self, salib_si='S1', **kwargs):
        ...
        kwargs :
            Keyword arguments passed on to
            pinar.util.plot.geo_scatter_categorical
    ...
    def to_hdf5(self, filename=None):
        ...
        filename : str or pathlib.Path, optional
            ...
            the default path is taken from pinar.config
    ...
    def from_hdf5(filename):
        ...
        Returns
        -------
        unc_output: pinar.engine.uncertainty.unc_output.UncOutput
...
class UncCostBenefitOutput(UncOutput):
    ...
    def __init__(self, samples_df, unit, imp_meas_present_unc_df, imp_meas_future_unc_df,
                 tot_pinar_risk_unc_df, benefit_unc_df, cost_ben_ratio_unc_df,
                 cost_benefit_kwargs):
        """Constructor
        ...
        imp_meas_future_unc_df : pandas.DataFrame
            ...
            (row of samples_df)
        tot_pinar_risk_unc_df : pandas.DataFrame
        ...
        self.tot_pinar_risk_unc_df = tot_pinar_risk_unc_df
        self.tot_pinar_risk_sens_df = None
