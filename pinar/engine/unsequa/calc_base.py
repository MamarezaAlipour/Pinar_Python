...
from pinar.util.value_representation import sig_dig as u_sig_dig
from pinar.engine.unsequa import UncOutput
...
class Calc():
    ...
    the uncertainty distribution for specific PINAR outputs see
    ...
    def sensitivity(self, unc_output, sensitivity_method = 'sobol',
        ...
        Returns
        -------
        sens_output : pinar.engine.uncertainty.unc_output.UncOutput()
