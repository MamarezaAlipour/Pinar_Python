...
from pinar.engine.cost_benefit import CostBenefit
from pinar.engine.unsequa import Calc, InputVar, UncCostBenefitOutput
from pinar.util import log_level
from pinar.hazard import Hazard
from pinar.entity import Entity
...
class CalcCostBenefit(Calc):
    ...
    pinar.engine.costbenefit.CostBenefit().

    Attributes
    ----------
    value_unit : str
        Unit of the exposures value
    haz_input_var : pinar.engine.uncertainty.input_var.InputVar
        Present Hazard uncertainty variable
    ent_input_var : pinar.engine.uncertainty.input_var.InputVar
        Present Entity uncertainty variable
    haz_unc_fut_Var: pinar.engine.uncertainty.input_var.InputVar
        Future Hazard uncertainty variable
    ent_fut_input_var : pinar.engine.uncertainty.input_var.InputVar
    ...
    _metric_names : tuple(str)
        ...
        ('tot_pinar_risk', 'benefit', 'cost_ben_ratio', 'imp_meas_present', 'imp_meas_future')
    """
    ...
    def __init__(
        ...
        ----------
        haz_input_var : pinar.engine.uncertainty.input_var.InputVar
                        or pinar.hazard.Hazard
            Hazard uncertainty variable or Hazard for the present Hazard
            in pinar.engine.CostBenefit.calc
        ent_input_var : pinar.engine.uncertainty.input_var.InputVar
                        or pinar.entity.Entity
            Entity uncertainty variable or Entity for the present Entity
            in pinar.engine.CostBenefit.calc
        haz_fut_input_var: pinar.engine.uncertainty.input_var.InputVar
                           or pinar.hazard.Hazard, optional
            Hazard uncertainty variable or Hazard for the future Hazard
            The Default is None.
        ent_fut_input_var : pinar.engine.uncertainty.input_var.InputVar
                            or pinar.entity.Entity, optional
    ...
    def uncertainty(self, unc_data, pool=None, **cost_benefit_kwargs):
        ...
        By default, imp_meas_present, imp_meas_future, tot_pinar_risk,
        ...
        unc_output.tot_pinar_risk_unc_df
        ...
        Parameters
        ----------
        unc_data : pinar.engine.uncertainty.unc_output.UncOutput
        ...
        cost_benefit_kwargs : keyword arguments
            Keyword arguments passed on to pinar.engine.CostBenefit.calc()

        Returns
        -------
        unc_output : pinar.engine.uncertainty.unc_output.UncCostBenefitOutput
        ...
        LOGGER.info("The freq_curve is not saved. Please "
                    "change the risk_func (see pinar.engine.cost_benefit) "
        ...
        tot_pinar_risk_unc_df = \
            pd.DataFrame(tot_pinar_risk, columns = ['tot_pinar_risk'])
        ...
        return UncCostBenefitOutput(samples_df=samples_df,
                                    ...
                                    tot_pinar_risk_unc_df=tot_pinar_risk_unc_df,
    ...
    def _map_costben_calc(self, param_sample, **kwargs):
        ...
        list
            ...
            imp_meas_present, imp_meas_future, tot_pinar_risk,
        ...
        # Extract from pinar.impact the chosen metrics
