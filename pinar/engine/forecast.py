...
from pinar.util.files_handler import to_list
import pinar.util.coordinates as u_coord
from pinar.util.value_representation import (
...
class Forecast:
    ...
    configurable save_dir in local_data (see pinar.util.config) under a name
    ...
    exposure : Exposure
        an PINAR Exposures containg values at risk
    exposure_name : str
    ...
    def __init__(
        ...
        hazard_dict : dict
            ...
            being a PINAR Hazard derived from that forecast for one event.
