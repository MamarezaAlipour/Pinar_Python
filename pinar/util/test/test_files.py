...
from pinar.util.files_handler import to_list, get_file_names, download_file, \
get_extension
from pinar.util.constants import DEMO_DIR, GLB_CENTROIDS_MAT, ENT_TEMPLATE_XLS
...
class TestExtension(unittest.TestCase):
    ...
    def test_get_extension_no_pass(self):
        """Test no extension"""
        file_name = '/Users/aznarsig/Documents/Python/pinar_python/data/demo/SC22000_VE__M1'
    ...
    def test_get_extension_one_pass(self):
        """Test not compressed"""
        file_name = '/Users/aznarsig/Documents/Python/pinar_python/data/demo/SC22000_VE__M1.grd'
        self.assertEqual('.grd', get_extension(file_name)[1])
        self.assertEqual(
            str(Path('/Users/aznarsig/Documents/Python/pinar_python/data/demo/SC22000_VE__M1')),
            get_extension(file_name)[0])

    def test_get_extension_two_pass(self):
        """Test compressed"""
        file_name = '/Users/aznarsig/Documents/Python/pinar_python' \
