...
from pinar.util.constants import HAZ_DEMO_FL, DEF_CRS, ONE_LAT_KM, DEMO_DIR
...
class TestFunc(unittest.TestCase):
    ...
    def test_set_df_geometry_points_pass(self):
        ...
        pinar.test.test_multi_processing.TestCoordinates.test_set_df_geometry_points_scheduled_pass
        """
...
class TestAssign(unittest.TestCase):
    ...
    def normal_pass(self, dist):
        """Checking result against matlab pinar_demo_step_by_step"""
        # Load input
    ...
    def normal_warning(self, dist):
        ...
        threshold = 40
        with self.assertLogs('pinar.util.coordinates', level='INFO') as cm:
