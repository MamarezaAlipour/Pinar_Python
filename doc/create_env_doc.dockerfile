...
ADD requirements/env_pinar.yml requirements/env_developer.yml ./

# Install requirements
RUN mamba env create -n pinar_doc -f env_pinar.yml \
    && mamba env update -n pinar_doc -f env_developer.yml
