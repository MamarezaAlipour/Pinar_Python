...
project = 'PINAR'
copyright = '2022, MamarezaAlipour'
author = 'PINAR contributors'
...
latex_documents = [
    (master_doc, 'pinar.tex', u'PINAR documentation',
     u'PINAR contributors', 'manual'),
]
